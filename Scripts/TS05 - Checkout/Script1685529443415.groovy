...
Mobile.startApplication('C:\\Users\\adria\\Downloads\\Android-MyDemoAppRN.1.2.0.build-231.apk', true)
...
Mobile.setText(findTestObject('Object Repository/android.widget.EditText - Rebecca Winter (1)'), 'Rebecca Winter', 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText - Mandorley 112'), 'Mandorley112', 0)
...
Mobile.setText(findTestObject('Object Repository/android.widget.EditText - United Kingdom'), 'United Kingdom', 0)

Mobile.tap(findTestObject('Object Repository/android.view.ViewGroup (3)'), 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText - Rebecca Winter (2)'), 'Rebecca Winter', 0)
...
Mobile.verifyElementText(findTestObject('Object Repository/android.widget.TextView - Checkout Complete'), 'Checkout Complete')
